...
If you wish to display a complete HTML page instead of just a `DIV` fragment, your code would look something like this:
...
// Assuming that some HTTP Request object is already available from somewhere...
...
var request = ... /* Get an HTTP request object from somewhere */
var event   = ... /* The HTTP event that triggered the execution of this function */
...
| Name | Return Type | Description
|---|---|---|
| `create_content` | `String` | Use `show_objects` instead
